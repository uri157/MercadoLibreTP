    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicationStates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPublication", x => new { x.Id, x.IdPublication });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPublicationState = table.Column<int>(type: "int", nullable: false),
                    IdProductState = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Publications_Categories_IdCategoria",
                        column: x => x.IdCategoria,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Publications_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Publications_ProductStates_IdProductState",
                        column: x => x.IdProductState,
                        principalTable: "ProductStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Publications_PublicationStates_IdPublicationState",
                        column: x => x.IdPublicationState,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserNotifications", x => new { x.IdNotification, x.Id });
                    table.ForeignKey(
                        name: "FK_UserNotifications_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserQuestions_Publications_IdPublication",
                        column: x => x.IdPublication,
                        principalTable: "Publications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishedArticles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WishedArticles_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WishedArticles_Publications_IdPublication",
                        column: x => x.IdPublication,
                        principalTable: "Publications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Publications_IdCategoria",
                table: "Publications",
                column: "IdCategoria");

            migrationBuilder.CreateIndex(
                name: "IX_Publications_IdProductState",
                table: "Publications",
                column: "IdProductState");

            migrationBuilder.CreateIndex(
                name: "IX_Publications_IdPublicationState",
                table: "Publications",
                column: "IdPublicationState");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserQuestions_IdPublication",
                table: "UserQuestions",
                column: "IdPublication");

            migrationBuilder.CreateIndex(
                name: "IX_WishedArticles_IdPublication",
                table: "WishedArticles",
                column: "IdPublication");
        }
